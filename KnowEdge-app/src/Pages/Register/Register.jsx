    ...
    return (
        <div className="register-container">
            <div className="register-card">
                <div className="logo-row"><span>Expert Path</span></div>
                <div className="register-title">Create an account</div>
                <div className="register-subtitle">Let's get started!</div>

                <form className="register-form" onSubmit={handleSubmit}>
                    <div className="input-group">
                        <span className="icon"><img src={black_user_icon} alt="Name" /></span>
                        <input type="text" name="name" placeholder="Name" value={form.name} onChange={handleChange} required />
                    </div>
                    <div className="input-group">
                        <span className="icon"><img src={mail_icon} alt="E-mail" /></span>
                    ...
                    <div className="input-group">
                        <span className="icon"><img src={key_icon} alt="Confirm Password" /></span>
                ...
                <button className="social-btn google" onClick={handleGoogleSignIn}>
                    <img src={google_icon} alt="Google" /> Sign up with Google
                </button>

                <button className="social-btn facebook" onClick={handleFacebookSignIn}>
                    <img src={facebook_icon} alt="Facebook" /> Sign up with Facebook
                </button>
            </div>
